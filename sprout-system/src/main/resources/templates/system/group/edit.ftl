                    ...
                    <form id="inputForm" class="form-horizontal" action="${ctx}/system/group/save" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group generic">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="tel" name="linker" class="form-control" value="${group.linker!}"/>
                                </div>
                            </div>
                            <div class="form-group generic">
                                <label for="linkerMobile" class="col-sm-2 control-label">联系人电话</label>
                                <div class="col-sm-10">
                                    <input type="text" id="linkerMobile" name="linkerMobile" class="form-control" value="${group.linkerMobile!}"/>
                                </div>
                            </div>
                            <div class="form-group">
