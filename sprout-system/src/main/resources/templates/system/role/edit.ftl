                    ...
                    <form id="inputForm" class="form-horizontal" action="${ctx}/system/role/save/" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="name" name="name" class="form-control" maxlength="20" value="${role.name!}" required/>
                                </div>
                            </div>
                            <div class="form-group db">
                                <label for="code" class="col-sm-2 control-label">角色代码</label>
                                <div class="col-sm-10">
                                    <input type="text" id="code" name="code" class="form-control" maxlength="20" value="${role.code!}" required/>
                                </div>
                            </div>
                            <div class="form-group db">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <#else>
                                        <label class="radio-inline"><input type="radio" class="minimal" name="enabled" value="true"/> 启用</label>
                                        <label class="radio-inline"><input type="radio" class="minimal" name="enabled" value="false" checked="checked"/> 禁用</label>
                                    </#if>
                                </div>
                            </div>
                            <div class="form-group db">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="3" id="description" name="description" class="form-control" maxlength="200">${role.description!}</textarea>
                                </div>
                            </div>
                        </div>
