                    ...
                    <form id="inputForm" class="form-horizontal" action="${ctx}/devops/serverHost/save/" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group db">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" id="password" name="password" class="form-control" maxlength="20" value="${serverHost.password!}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="controlType" class="col-sm-2 control-label">控制方式</label>
                                <div class="col-sm-10">
                                    <select id="controlType" name="controlType" class="form-control">
                                        <#list controlTypeList as controlType>
                                            <#if serverHost.controlType==controlType>
                                                <option value="${controlType}" selected>${controlType}</option>
                                            <#else >
